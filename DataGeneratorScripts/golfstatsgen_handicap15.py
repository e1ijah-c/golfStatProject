...
CLUB_DISTS = [225, 185, 165, 160, 155, 145, 135, 125, 115, 85, 70, 55, 10]
LIES = ["TEE BOX", "FAIRWAY", "FAIRWAY", "FAIRWAY", "FAIRWAY", "ROUGH", "ROUGH", "ROUGH", "BUNKER", "OTHER/HAZARD", "GREEN"]

PAR_3_MAX, PAR_3_MIN = 240, 100
PAR_4_MAX, PAR_4_MIN = 450, 280
PAR_5_MAX, PAR_5_MIN = 580, 450

data, distances, clubs, lies = [], [], [], []

randClub, strokes, totalStrokes = 0, 0, 0
...
for i in range(18):
    ...
    while dist2Go > 15:
        ...
        if dist2Go > 240 and strokes == 0:
            randClub = 0
            strokeDist = random.randint(CLUB_DISTS[randClub] - 15, CLUB_DISTS[randClub] + 5)
        elif dist2Go > 200:
...
tuples = list(zip(HOLE, PARS, YARDAGE, STROKES, STROKE_1_DISTANCE, STROKE_1_CLUB, STROKE_1_LIE, 
                  STROKE_2_DISTANCE, STROKE_2_CLUB, STROKE_2_LIE, 
                  STROKE_3_DISTANCE, STROKE_3_CLUB, STROKE_3_LIE, 
                  STROKE_4_DISTANCE, STROKE_4_CLUB, STROKE_4_LIE, 
                  STROKE_5_DISTANCE, STROKE_5_CLUB, STROKE_5_LIE, 
...
df = pd.DataFrame(tuples, columns = ['HOLE', 'PARS', 'YARDAGE', 'STROKES', 'STROKE_1_DISTANCE', 'STROKE_1_CLUB', 'STROKE_1_LIE', 
                  'STROKE_2_DISTANCE', 'STROKE_2_CLUB', 'STROKE_2_LIE', 
                  'STROKE_3_DISTANCE', 'STROKE_3_CLUB', 'STROKE_3_LIE', 
                  'STROKE_4_DISTANCE', 'STROKE_4_CLUB', 'STROKE_4_LIE', 
                  'STROKE_5_DISTANCE', 'STROKE_5_CLUB', 'STROKE_5_LIE', 
